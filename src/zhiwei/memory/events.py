...
# revoke/delete 级联（ForgetManager CascadeEffect → 台账；F-R6-02：级联事件
# 与转移同事务落台账 + 审计链，不留在进程内存里）
ACTION_RECORD_INDEX_INVALIDATED = "record.index_invalidated"
ACTION_RECORD_CACHE_INVALIDATED = "record.cache_invalidated"
