...
app.add_typer(operations.ops_app, name="ops", help="故障注入与固定负载")
app.add_typer(operations.backup_app, name="backup", help="备份创建与校验")
app.add_typer(operations.restore_app, name="restore", help="隔离恢复校验")
