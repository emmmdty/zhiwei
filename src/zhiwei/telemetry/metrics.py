...
# S11-T6 负载测量词汇（F-R8-06 RED 冻结：先扩常量声明形态，禁止运行期造名）。
# p50/p95 不在此处——histogram 把原始值交给后端，分位是报告层对原始样本的聚合。
METRIC_LOAD_LATENCY = "zhiwei.load.latency"
METRIC_LOAD_QUEUE_WAIT = "zhiwei.load.queue_wait"
METRIC_LOAD_RECOVERY = "zhiwei.load.recovery"
METRIC_LOAD_TERMINAL = "zhiwei.load.terminal"
METRIC_LOAD_ERRORS = "zhiwei.load.errors"
